...
### Added
- pi): use remote-aware CLI transport for todo extension
- web): create tasks with the inline editor
...
### Added
- Add authenticated remote workspaces with offline sync and conflict resolution
- Add native server installation, OAuth workspaces, and safe local migrations

## [0.6.1] - 2026-09-08
You've hit your session limit · resets 5:50pm (Atlantic/Reykjavik)

### Added
- Add web server lifecycle controls to the CLI and TUI
...
### Added
- folder-aware project selection

### Fixed
- make release recipe work from git worktrees
...
### Added
- todo CRUD CLI, shared ops layer, and totui work-mirroring skill
...
### Added
- help): improve shortcut guidance
...
### Added
- midnight rollover with tri-state auto preference
...
Copy by selecting text with mouse.
